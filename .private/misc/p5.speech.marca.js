...
/* Modified by Marca: don't print "Voices loaded" on the console; return list of names instead of printing them. */
/**
 * @module p5.speech
 * @submodule p5.speech
 * @for p5.speech
...
// =============================================================================
  ...
  p5.Speech = function(_dv, _callback) {
    ...
    window.speechSynthesis.onvoiceschanged = function() {
      if(that.isLoaded==0) { // run only once
        ...
        // console.log("p5.Speech: voices loaded!");  // commnted out by Marca
  ...
  // getVoices() - return voice names
  // added by Marca
  p5.Speech.prototype.getVoices = function() {
    if (this.isLoaded) {
      return this.voices.map(function(voice) { return voice.name; } ).filter(function(voiceName) { return voiceName.indexOf('Google') == -1 });
    } else {
      return [];
    }
  };
